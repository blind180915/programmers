...
public class BruteForceSearch42842 {
	...
	public static int[] solution(int brown, int red) {
        ...
        for(int i = 1; i <= red / 2; ++i) {
        	if(red % i == 0) {
        		temp = (i + 2) * (red / i + 2);
        		if(red + brown == temp) {
        			answer[0] = (i + 2) < (red / i + 2) ? red / i + 2 : i + 2;
        			answer[1] = (i + 2) < (red / i + 2) ? i + 2 : red / i + 2;
        		}
        	}
        }
	...
	public int[] otherSolution(int brown, int red) {
        int a = (brown+4)/2;
        int b = red+2*a-4;
	...
	public int[] otherSolution2(int brown, int red) {
        for(int i=1; i<=red; i++) {
	...
	public int[] otherSolution3(int brown, int red) {
        int[] answer = {};
        answer = new int[2];
